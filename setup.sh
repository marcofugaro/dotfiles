...
brew install --cask google-chrome firefox-nightly slack discord hyper visual-studio-code sublime-text alfred spotify vlc table-tool android-file-transfer mysides blender
